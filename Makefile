...
SRCS	=	$(main)/minishell.c \
			...
			$(utils)/print_return.c $(utils)/split_minishell_args.c $(utils)/split_minishell_dir.c $(utils)/clear_objects.c $(utils)/ft_split_quotes.c \
			$(utils)/ft_math.c $(utils)/ft_split_test.c\
			$(comm)/ft_cd.c \
			$(comm)/ft_pwd.c \
			$(comm)/ft_echo.c \
			$(comm)/ft_env.c \
